...
bomb_main =transform.scale(image.load("Fruit Images/bomb.png"), (128, 128)).convert()
bomb_bit1 = transform.scale(image.load("Fruit Images/bombbit1.png"), (84, 98)).convert()
bomb_bit2 = transform.scale(image.load("Fruit Images/bombbit2.png"), (36, 68)).convert()
...
Fruit_Images = {"apple": apple_main, "banana": banana_main, "coconut": coconut_main, "lemon": lemon_main, \
                "pear": pear_main, "watermelon": watermelon_main,"strawberry":strawberry_main,"mango":mango_main,"orange":orange_main,"pineapple":pineapple_main,"pome":pome_main,"pumpkin":pumpkin_main,"tomato":tomato_main,"bomb":banana_main}

Bit_Images1 = {"apple": apple_bit1, "banana": banana_bit1, "coconut": coconut_bit1, "lemon": lemon_bit1, \
               "pear": pear_bit1, "watermelon": watermelon_bit1,"strawberry":strawberry_bit1,"mango":mango_bit1,"orange":orange_bit1,"pineapple":pineapple_bit1,"pome":pome_bit1,"pumpkin":pumpkin_bit1,"tomato":tomato_bit1,"bomb":banana_bit1}

Bit_Images2 = {"apple": apple_bit2, "banana": banana_bit2, "coconut": coconut_bit2, "lemon": lemon_bit2, \
               "pear": pear_bit2, "watermelon": watermelon_bit2,"strawberry":strawberry_bit2,"mango":mango_bit2,"orange":orange_bit2,"pineapple":pineapple_bit2,"pome":pome_bit2,"pumpkin":pumpkin_bit2,"tomato":tomato_bit2,"bomb":bomb_bit2}
...
song1 = mixer.Sound("Sounds/Pompeii.wav"); song1.set_volume(0.25) #  fruit original
song2 = mixer.Sound("Sounds/All I Do Is Win.wav"); song2.set_volume(0.65) #jumanjı
song3 = mixer.Sound("Sounds/Animals.wav"); song3.set_volume(0.45) #sky 
song4 = mixer.Sound("Sounds/Wipe Out.wav"); song4.set_volume(0.95) # temple run 
song = song3                
...
def randfruit():
    fruits = ["apple", "banana", "coconut", "lemon", "pear", "watermelon","strawberry","mango","orange","pineapple","pome","pumpkin","tomato","bomb"]  
...
CollisionRadius = {"apple": 10, "banana": 64, "coconut": 40, "lemon": 50, "pear": 40, "watermelon": 50,"strawberry":10,"mango":60,"orange":40,"pineapple":40,"pome":40,"pumpkin":40,"tomato":40,"bomb":40} 
